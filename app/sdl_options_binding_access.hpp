...
bool sdl_options_axis_row(int row, InputSlot& slot);
bool sdl_options_axis_invert_row(int row, InputSlot& slot);
...
ControllerAxis controller_axis_for_options_row(const ActionInputBindings& bindings, int row);
bool controller_axis_inverted_for_options_row(const ActionInputBindings& bindings, int row);
