...
void test_direction_rows_still_describe_button_bindings() {
    ...
    constexpr whacker::app::OptionsMenuSection section = whacker::app::OptionsMenuSection::Controls;

    TEST_CHECK(whacker::app::sdl_options_binding_row(section, whacker::app::OptionsControlsRowP1Up, row));
    TEST_CHECK(row.slot == whacker::app::InputSlot::P1);
    TEST_CHECK(row.direction == whacker::app::AxisDirection::Negative);
    TEST_CHECK(
        whacker::app::controller_button_for_options_row(bindings, section, whacker::app::OptionsControlsRowP1Up) ==
        whacker::app::ControllerButton::DpadUp);

    TEST_CHECK(whacker::app::sdl_options_binding_row(section, whacker::app::OptionsControlsRowP2Down, row));
    TEST_CHECK(row.slot == whacker::app::InputSlot::P2);
    TEST_CHECK(row.direction == whacker::app::AxisDirection::Positive);
    TEST_CHECK(
        whacker::app::controller_button_for_options_row(bindings, section, whacker::app::OptionsControlsRowP2Down) ==
...
void test_axis_rows_describe_analog_move_bindings() {
    ...
    TEST_CHECK(whacker::app::sdl_options_axis_row(section, whacker::app::OptionsControlsRowP1Axis, slot));
    TEST_CHECK(slot == whacker::app::InputSlot::P1);
    whacker::app::SdlOptionsBindingRow direction_row {};
    TEST_CHECK(!whacker::app::sdl_options_binding_row(section, whacker::app::OptionsControlsRowP1Axis, direction_row));
    TEST_CHECK(
        whacker::app::controller_axis_for_options_row(bindings, section, whacker::app::OptionsControlsRowP1Axis) ==
        whacker::app::ControllerAxis::LeftY);
    TEST_CHECK(!whacker::app::controller_axis_inverted_for_options_row(
        bindings,
        section,
        whacker::app::OptionsControlsRowP1AxisInvert));
    ...
    whacker::app::bind_player_move_axis(
        ...
        true);
    TEST_CHECK(whacker::app::sdl_options_axis_row(section, whacker::app::OptionsControlsRowP2Axis, slot));
    TEST_CHECK(slot == whacker::app::InputSlot::P2);
    TEST_CHECK(
        whacker::app::controller_axis_for_options_row(bindings, section, whacker::app::OptionsControlsRowP2Axis) ==
        whacker::app::ControllerAxis::RightX);
    TEST_CHECK(whacker::app::controller_axis_inverted_for_options_row(
        bindings,
        section,
        whacker::app::OptionsControlsRowP2AxisInvert));
}
